                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li><a href="">(INEC) E-Voting Site Admin Login Page</a></li>
    ...
    <div class="container">
        ...
        <div class="col-md-6 col-md-offset-3 col-sm-12 wow fadeInRight" data-wow-delay=".8s">
            <div class="omb_login text-center">
                ...
                <h4 class="text-center"><?php login_admin('admin.php'); ?>
                ...
                <div class="row omb_row-sm-offset-">
                    <div class="col-xs-12 col-sm-12">
                        <form class="omb_loginForm" action="" autocomplete="off" method="POST">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                <input  type="password" class="form-control" name="secret" placeholder="Secret Code">
                            </div>
