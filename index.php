...
<section id="banner" class="wow fadeInUp">
        ...
        <div class="container" >
            ...
            if(isset($_POST['proceed'])) {
                ...
                if (user_exit('results', 'voters_id', $_SESSION['voters_id']) > 0) {
                    ...
                    die('<div class="alert alert-success" style="margin-top: 180px"><p class="text-center">Success!!! Your Vote has been Counted!<br>You will be redirected to the result page in few seconds</p></div><meta http-equiv="refresh" content="10;url=http://localhost/e-vote/results.php" />');
                }
            }
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <img src="images/candidates/<?php echo $passport ?>" height="100" width="90" class="img-circle" />
                    ...
                    while($row = mysqli_fetch_assoc($select_party_id)){
                        ...
                        <div class="col-md-2">
                            <img src="images/party/<?php echo $party_logo ?>" class="" />
                        </div>
            ...
            <!--                    <input type="submit" name="vote" value="vote" class="btn btn-primary pull-right" />-->
            <!--                </div>-->
            <!--            </div>-->
...
<footer class="wow fadeInUp" data-wow-delay=".8s">
    <div class="container text-center">
        <div class="row">
            <div class="col-md-12">
                <p>Copyright © 2017 Medik. All rights reserved.</p>
