                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown" style="margin-top:1.0em">
   <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><?php echo $v_position ?> Results
...
<section id="banner" class="wow fadeInUp">
    ...
    <div class="container">
        ...
        <h2 class="text-center"><?php echo $v_date .' '.  $v_position ?> Election Results</h2><br><br>
            ...
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <img src="images/candidates/<?php echo $passport ?>" height="50" width="50" class="img-circle" />
