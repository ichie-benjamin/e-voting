...
<header>
   ...
   <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Governorship Results
...
<section id="banner" class="wow fadeInUp">
    ...
    <div class="container">
        ...
        <h2 class="text-center">Recent <?php echo $state ?> State Governorship Election Results</h2><br><br>
        ...
        <hr>
            ...
            $query = "SELECT * FROM candidates WHERE position = 'governorship' AND state_of_origin = '{$state}' ORDER BY vote_count DESC";
